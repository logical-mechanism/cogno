...
| `runtime/` | `cogno-chain-runtime` (`#[frame_support::runtime]`, **spec_version 223 / tx_version 8**) |
...
- **Spec-bump discipline.** Encoding-affecting runtime changes (calls/storage/events/extensions) bump
  `spec_version` (currently **223**); after a bump, regenerate PAPI descriptors against a LOCAL dev node
