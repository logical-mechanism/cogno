...
| `runtime/` | `cogno-chain-runtime` (`#[frame_support::runtime]`, **spec_version 224 / tx_version 8**) |
...
- **Spec-bump discipline.** Encoding-affecting runtime changes (calls/storage/events/extensions) bump
  `spec_version` (currently **224**); after a bump, regenerate PAPI descriptors against a LOCAL dev node
