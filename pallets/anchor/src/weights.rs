...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	/// Storage: `Anchor::LastCheckpoint` (r:1 w:1)
	/// Proof: `Anchor::LastCheckpoint` (`max_values`: Some(1), `max_size`: Some(84), added: 579, mode: `MaxEncodedLen`)
	fn anchor_ack() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `42`
		//  Estimated: `1569`
		// Minimum execution time: 7_526_000 picoseconds.
		Weight::from_parts(8_803_000, 1569)
