...
// useWhoToFollow — the RightRail ranked suggestions (indexer-only; caps.whoToFollow). Filters out
// the viewer + anyone they already follow (client-side, via followEdges). Returns nothing on
// PAPI-direct so the surface omits the block.
