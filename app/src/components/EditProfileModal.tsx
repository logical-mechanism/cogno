...
export function EditProfileModal({
  ...
  // set_profile / clear_profile can't land. Gate both actions off it (the NoPostingPowerNotice below
  // explains why — and shows the timed "crediting" state when a lock is still settling). A missing
  // stake bind is NOT a block here, for the same reason it is not one in the composer: it writes
  // voting power and nothing the profile write touches.
