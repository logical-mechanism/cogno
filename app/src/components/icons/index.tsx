...
export function IconBookmark(p: IconProps) {
  ...
  return (
    <svg {...svgProps(p)}>
      <path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15.18l-5-2.15-5 2.15V5h10v13.18z" />
    </svg>
  );
}
...
export function IconPlay(p: IconProps) {
  // Play-triangle silhouette — the click-to-reveal cover affordance for a gated video.
  return (
    <svg {...svgProps(p)}>
...
export function IconSpeaker(p: IconProps) {
  // Material "volume_up" silhouette — the click-to-reveal cover affordance for a gated audio clip.
  return (
    <svg {...svgProps(p)}>
